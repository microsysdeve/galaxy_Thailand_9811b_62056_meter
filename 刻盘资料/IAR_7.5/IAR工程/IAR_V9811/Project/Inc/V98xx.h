...
__sfr __no_init volatile unsigned char  SysCtrl @0x80; //Clock Switchover Control Register	
__sfr __no_init volatile unsigned char  RTCPEN @0x90; //RTC Password Enable Register
__sfr __no_init volatile unsigned char  RTCYC @0x93; //to set the year information	
__sfr __no_init volatile unsigned char  RTCCH @0x94; //RTC Calibration Registers	
__sfr __no_init volatile unsigned char  RTCCL @0x95; //RTC Calibration Registers	
__sfr __no_init volatile unsigned char  INTRTC @0x96; //RTC Wake-up Interval Register	
__sfr __no_init volatile unsigned char  RTCPWD @0x97; //RTC Password Register	
__sfr __no_init volatile unsigned char  RTCSC @0x9A; //to set the second information	
__sfr __no_init volatile unsigned char  RTCMiC @0x9B; //to set the minute information	
__sfr __no_init volatile unsigned char  RTCHC @0x9C; //to set the hour information	
__sfr __no_init volatile unsigned char  RTCDC @0x9D; //to set the day information	
__sfr __no_init volatile unsigned char  RTCWC @0x9E; //to set the day of week information	
__sfr __no_init volatile unsigned char  RTC_MON @0x9F; //to set the month information	
__sfr __no_init volatile unsigned char  CBANK @0xA0; //code bank	
__sfr __no_init volatile unsigned char  Systate @0xA1; //System State Register	
__sfr __no_init volatile unsigned char  PLLLCK @0xA3; //PLL Clock State Register	
__sfr __no_init volatile unsigned char  P9OE @0xA4; //P9 Output Enable Register	
__sfr __no_init volatile unsigned char  P9IE @0xA5; //P9 Input Enable Register	
__sfr __no_init volatile unsigned char  P9OD @0xA6; //P9 Output Data Register	
__sfr __no_init volatile unsigned char  P9ID @0xA7; //P9 Input Data Register	
__sfr __no_init volatile unsigned char  P10OE @0xA9; //P10 Output Enable Register	
__sfr __no_init volatile unsigned char  P10IE @0xAA; //P10 Input Enable Register	
__sfr __no_init volatile unsigned char  P10OD @0xAB; //P10 Output Data Register	
__sfr __no_init volatile unsigned char  P10ID @0xAC; //P10 Input Data Register	
__sfr __no_init volatile unsigned char  P9FS @0xAD; //P9 Special Function Register	
__sfr __no_init volatile unsigned char  IOWKDET @0xAF; //P0 IO Wakeup Flag Register	
__sfr __no_init volatile unsigned char  IOEDG @0xC7; //IO Wakeup Edge Control Register	
__sfr __no_init volatile unsigned char  IOWK @0xC9; //IO Wakeup Control Register	
__sfr __no_init volatile unsigned char  WDTEN @0xCE; //	
__sfr __no_init volatile unsigned char  WDTCLR @0xCF; //	
__sfr __no_init volatile unsigned char  RDRTC @0xDA; //RTC Data Reading Enable Register	
__sfr __no_init volatile unsigned char  DIVTHH @0xDB; //PLL Clock Divider Registers	
__sfr __no_init volatile unsigned char  DIVTHM @0xDC; //PLL Clock Divider Registers	
__sfr __no_init volatile unsigned char  DIVTHL @0xDD; //PLL Clock Divider Registers	
__sfr __no_init volatile unsigned char  PLLCNT @0xDE; //PLL Counter State Register	
__sfr __no_init volatile unsigned char  SECINT @0xDF; //RTC Seconds Wake-up Interval Configuration Register	
