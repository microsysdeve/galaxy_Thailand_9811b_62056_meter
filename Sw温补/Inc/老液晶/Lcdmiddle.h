...
#define     Ut_KW       (S36+COM5)// KW
#define     Ut_H        (0)// h
//#define     Ut_cos      (0)// cos
//#define     Ut_yuan     (0)// 元
//#define     Ut_Reserved (0)//预留

#define     Len_UnitBit 1
