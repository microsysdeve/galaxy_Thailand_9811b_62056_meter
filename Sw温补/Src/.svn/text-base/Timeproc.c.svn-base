...
void SleepTimeProc(void)
{
    ...
    if(RTCCheck((uint8*)&gs_ClkTmp) != Const_Data_OK)                               //判断RTC时钟是否正确
    {
        ...
        gs_MeterState.ui_MeterState1.RunCode1Word.RTCErr = true;
        Rpt_StaSet(RPT_RTCERR);
    ...
    }else                                                                           //正确，拷贝RTC时钟到RAM时钟
    {
        ...
        gs_MeterState.ui_MeterState1.RunCode1Word.RTCErr = false;
        Rpt_StaFlgClr(RPT_RTCERR);
    }
