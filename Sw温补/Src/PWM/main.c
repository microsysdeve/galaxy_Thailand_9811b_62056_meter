...
__no_init  volatile unsigned char xdata  TACTL   _at_   0x2900;
__no_init  volatile unsigned char xdata  TACCTL0   _at_ 0x2904;
__no_init  volatile unsigned char xdata  TACCTH0   _at_ 0x2905;

__no_init  volatile unsigned char xdata  TACCRL0   _at_ 0x290A;
__no_init  volatile unsigned char xdata  TACCRH0   _at_ 0x290B;
...
//      DelayOSC(187);
    ...
    while (1)
    {
        ...
        TACCTH0 = 0;
        TACCTL0 = 0x80;//当 TAR=TACCRx（x=0~2）时，相应引脚 Tax 的输出翻转
        TACTL = 0x18;  //分频系数为 2  Up Mode   fMCU
