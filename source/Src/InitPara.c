...
{
    0x40,0x06,     //表常数 1600
    0xC0,0x5D,     //标称电压 240.00
    0x88,0x13,     //标称电流 5.000
    0xAC,0x73,0xF8,0x02,//有功能量脉冲门限值
    0xE3,0x24,0x4F,0x19,//800K常数计量门限
    0x00,0x1B,0xB7,0x00,//有功能量潜动门限值
    0x67,0xEB,0xE3,0x05,//I2常数门限
    ...
    0x00,               //通道I1角差校正值
    0x00,               //通道I2角差校正值
    0x70,0x65,0x62,0x01,//功率1显示比例系数k
    0x70,0x65,0x62,0x01,//功率2显示比例系数k
    0x85,0xA3,0xB3,0x65,//电压显示比例系数k
    0xCC,0xCC,0x4E,0x1C,//电流I1显示比例系数k
    0xCC,0xCC,0x4E,0x1C,//电流I2显示比例系数k 与I1倍数关系
...
const uint8 code InitPara_Px[sizeof(S_JBPM)-2+4]=
{
    0x40,0x06,     //表常数 1600
    0xC0,0x5D,     //标称电压 240.00
    0x88,0x13,     //标称电流 5.000
    ...
    0x0C,               //通道增益
    //CRC
    (_ChipDataSet_Bz_>>24)&0xff,(_ChipDataSet_Bz_>>16)&0xff,(_ChipDataSet_Bz_>>8)&0xff,(_ChipDataSet_Bz_)&0xff,
};
