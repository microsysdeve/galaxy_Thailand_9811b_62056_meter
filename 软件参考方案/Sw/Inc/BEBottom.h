...
#define _SW_BE_Type  Const_AT24C64
...
//常量定义
    ...
    #define BE_Const_DyWrite    20      // 延时5ms的时间（每个单位是5us）
...
//端口定义
#define BE_I2C_CLK_1()      {P1OD |=BIT2; P1IE &=~BIT2;P1OE &=~BIT2; }   //CLK=1
#define BE_I2C_CLK_0()      {P1OD &=~BIT2;P1IE &=~BIT2;P1OE &=~BIT2; }   //CLK=0


#define BE_I2C_SDA_1()      {P1OD |=BIT1; P1IE &=~BIT1;P1OE &=~BIT1; }   //SDA=1
#define BE_I2C_SDA_0()      {P1OD &=~BIT1;P1IE &=~BIT1;P1OE &=~BIT1; }   //SDA=0

#define BE_I2C_SDA_IN()     {P1OE |=BIT1;P1IE |=BIT1;}                   //设置成输入模式
#define BE_I2C_SDA_ST       (P1ID&BIT1)                                  //读取数据线上的信号
